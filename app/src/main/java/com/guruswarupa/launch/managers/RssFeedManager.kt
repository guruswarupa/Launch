...
class RssFeedManager(
    ...
    companion object {
        ...
        private val PRESET_FEEDS = listOf(
            ...
            RssFeedSource("Times of India", "https://timesofindia.indiatimes.com/rssfeedstopstories.cms", "India"),
            RssFeedSource("NDTV Top Stories", "https://feeds.feedburner.com/ndtvnews-top-stories", "India"),
            RssFeedSource("News18 India", "https://www.news18.com/rss/india.xml", "India"),
            RssFeedSource("Livemint", "https://www.livemint.com/rss/news", "India"),
            ...
            RssFeedSource("CNET", "https://www.cnet.com/rss/news/", "Technology"),
            RssFeedSource("ZDNet", "https://www.zdnet.com/news/rss.xml", "Technology"),
            RssFeedSource("Mashable", "https://mashable.com/feeds/rss/all", "Technology"),
            RssFeedSource("VentureBeat", "https://venturebeat.com/feed/", "Technology"),
            RssFeedSource("9to5Mac", "https://9to5mac.com/feed/", "Technology"),
            RssFeedSource("9to5Google", "https://9to5google.com/feed/", "Technology"),
            RssFeedSource("MacRumors", "https://feeds.macrumors.com/MacRumors-All", "Technology"),
            ...
            RssFeedSource("Space.com", "https://www.space.com/feeds/all", "Science"),
            RssFeedSource("Nature News", "https://www.nature.com/nature.rss", "Science"),
            ...
            RssFeedSource("BBC Politics", "https://feeds.bbci.co.uk/news/politics/rss.xml", "Politics"),
            ...
            RssFeedSource("PC Gamer", "https://www.pcgamer.com/rss/", "Games"),
            RssFeedSource("Eurogamer", "https://www.eurogamer.net/feed", "Games"),
            RssFeedSource("Rock Paper Shotgun", "https://www.rockpapershotgun.com/feed", "Games"),
            ...
            RssFeedSource("Deadline", "https://deadline.com/feed/", "Entertainment"),
            ...
            RssFeedSource("Investing.com News", "https://www.investing.com/rss/news.rss", "Finance"),
            ...
            RssFeedSource("The Guardian Environment", "https://www.theguardian.com/environment/rss", "Environment"),
            ...
            RssFeedSource("Jalopnik", "https://jalopnik.com/rss", "Automotive"),
            RssFeedSource("The Drive", "https://www.thedrive.com/feed", "Automotive"),
            ...
            RssFeedSource("CDC Newsroom", "https://tools.cdc.gov/api/v2/resources/media/132608.rss", "Health"),
            ...
            RssFeedSource("Al Jazeera", "https://www.aljazeera.com/xml/rss/all.xml", "News"),
            RssFeedSource("CNN Top Stories", "http://rss.cnn.com/rss/cnn_topstories.rss", "News"),
            RssFeedSource("Sky News World", "https://feeds.skynews.com/feeds/rss/world.xml", "News"),
            RssFeedSource("DW All", "https://rss.dw.com/xml/rss-en-all", "News"),
            RssFeedSource("France 24", "https://www.france24.com/en/rss", "News")
        )
